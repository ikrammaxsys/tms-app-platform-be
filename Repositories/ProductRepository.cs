...
// In-memory store standing in for real DB operations. Inject ISqlExecutor and
// replace method bodies with QueryAsync / ExecuteNonQueryAsync when ready.
public sealed class ProductRepository : IProductRepository
{
    ...
    public ProductItem Add(ProductItem product)
    {
